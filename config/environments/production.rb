...
# مؤقتاً خليه true باش Heroku ما يطيحش فالـ assets
  ...
  # config.active_job.queue_name_prefix = "clinic_saas_production"

  config.action_mailer.perform_caching = false
  config.action_mailer.perform_deliveries = ENV.fetch("MAILER_PERFORM_DELIVERIES", "true") == "true"
  config.action_mailer.raise_delivery_errors = true

  app_host =
    ENV["APP_HOST"].presence ||
    ENV["RAILS_APP_HOST"].presence ||
  ...
  routes.default_url_options = { host: app_host, protocol: app_protocol }
